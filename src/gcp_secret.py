...
class GCPSecret():
    ...
    def delete_gcp_secret(self, project_id: str, secret_id: str) -> None:
        """
    ...
    def get_gcp_secret(self, project_id: str, secret_id: str, version_id: str = "latest") -> str:
        """
    ...
    def update_gcp_secret(self, project_id: str, secret_id: str, new_secret_value: str) -> str:
        """
